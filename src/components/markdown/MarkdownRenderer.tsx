    ...
    <div className={`markdown-content ${className}`}>
      <ReactMarkdown
        ...
        components={{
          ...
          // Paragraphs
          p: ({ children }) => (
            <p className="app-text-md app-text-primary mb-3 relative font-h02-heading02 font-[number:var(--text-font-weight)] text-[color:var(--light-mode-colors-dark-gray-900)] text-[16px] tracking-[var(--text-letter-spacing)] leading-[var(--text-line-height)] [font-style:var(--text-font-style)] break-words">
              {children}
            </p>
          ),

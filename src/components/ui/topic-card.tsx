  ...
  return (
    <button
      ...
      className={cn(
        ...
        isSelected
          ? isDark 
            ? "bg-[color:var(--tokens-color-surface-surface-card-purple)] border-[color:var(--tokens-color-surface-surface-card-purple)] text-[color:var(--tokens-color-surface-surface-dark)]"
    ...
    >
      <Icon
        className={cn(
          ...
          isSelected ? (isDark ? "text-[color:var(--tokens-color-surface-surface-dark)]" : "text-white") : "text-tokens-color-text-text-brand"
        )}
        color={isSelected ? (isDark ? 'var(--tokens-color-surface-surface-dark)' : '#FFFFFF') : undefined}
      />
      <div
        className={cn(
